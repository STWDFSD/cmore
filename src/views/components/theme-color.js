...
exports.loadAccumulationChartTheme =
  exports.loadChartTheme =
  exports.pointFluent2HighContrastColors =
  exports.pointFluent2DarkColors =
  exports.pointFluent2Colors =
  exports.pointMaterial3DarkColors =
  exports.pointMaterial3Colors =
  exports.pointTailwind3DarkColors =
  exports.pointTailwind3Colors =
  exports.pointTailwindDarkColors =
  exports.pointTailwindColors =
  exports.pointFluentDarkColors =
  exports.pointFluentColors =
  exports.pointBootstrap5DarkColors =
  exports.pointBootstrap5Colors =
  exports.pointHighContrastColors =
  exports.pointBootstrapColors =
  exports.pointFabricColors =
  exports.pointMaterialDarkColors =
  exports.pointMaterialColors =
  exports.bubbleFluent2DarkColors =
  exports.bubbleFluent2HighContrastColors =
  exports.bubbleFluent2Colors =
  exports.bubbleMaterial3DarkColors =
  exports.bubbleMaterial3Colors =
  exports.bubbleTailwind3DarkColors =
  exports.bubbleTailwind3Colors =
  exports.bubbleTailwindDarkColors =
  exports.bubbleTailwindColors =
  exports.bubblePointFluentDarkColors =
  exports.bubblePointFluentColors =
  exports.bubblePointBootstrap5DarkColors =
  exports.bubblePointBootstrap5Colors =
  exports.bubblePointHighContrastColors =
  exports.bubblePointBootstrapColors =
  exports.bubblePointFabricColors =
  exports.bubblePointMaterialDarkColors =
  exports.bubblePointMaterialColors =
  exports.keyBootstrapdarkColors =
  exports.keyBootstrap4Colors =
  exports.keyFabricDark =
  exports.fluent2HighContrastColors =
  exports.fluent2DarkColors =
  exports.fluent2Colors =
  exports.fluentDarkColors =
  exports.fluentColors =
  exports.highContrastColors =
  exports.bootstrapColors =
  exports.fabricColors =
  exports.materialColors =
    void 0;
exports.piePointRender =
  exports.roundedPointRender =
  exports.roundedCornnerPointRender =
  exports.donutPointRender =
  exports.bubblePointRender =
  exports.pointRenderEvent =
  exports.accpatternPointRender =
  exports.funnelPointRender =
    void 0;
/**
...
exports.bubblePointMaterialColors = [
  ...
  "rgba(64, 64, 65, 0.5)",
  "rgba(53, 124, 210, 0.5)",
  "rgba(229, 101, 144, 0.5)",
  "rgba(248, 184, 131, 0.5)",
  "rgba(112, 173, 71, 0.5)",
  "rgba(221, 138, 189, 0.5)",
  "rgba(127, 132, 232, 0.5)",
  "rgba(123, 180, 235, 0.5)",
  "rgba(234, 122, 87, 0.5)",
  "rgba(64, 64, 65, 0.5)",
  "rgba(0, 189, 174, 0.5)",
];
exports.bubblePointMaterialDarkColors = [
  "rgba(158, 203, 8, 0.5)",
  "rgba(86, 174, 255, 0.5)",
  "rgba(197, 122, 255, 0.5)",
  "rgba(97, 234, 169, 0.5)",
  "rgba(235, 187, 62, 0.5)",
  "rgba(244, 92, 92, 0.5)",
  "rgba(138, 119, 255, 0.5)",
  "rgba(99, 199, 255, 0.5)",
  "rgba(255, 132, 176, 0.5)",
  "rgba(247, 201, 40, 0.5)",
];
exports.bubblePointFabricColors = [
  "rgba(68, 114, 196, 0.5)",
  ...
  "rgba(111, 111, 226, 0.5)",
  "rgba(226, 105, 174, 0.5)",
  "rgba(158, 72, 14, 0.5)",
  "rgba(153, 115, 0, 0.5)",
  "rgba(68, 114, 196, 0.5)",
  "rgba(112, 173, 71, 0.5)",
...
exports.bubblePointBootstrapColors = [
  "rgba(161, 110, 229, 0.5)",
  "rgba(247, 206, 105, 0.5)",
  "rgba(85, 165, 194, 0.5)",
  "rgba(125, 223, 30, 0.5)",
  "rgba(255, 110, 166, 0.5)",
  "rgba(121, 83, 172, 0.5)",
  "rgba(185, 155, 79, 0.5)",
  "rgba(64, 124, 146, 0.5)",
  "rgba(94, 167, 22, 0.5)",
...
exports.bubblePointHighContrastColors = [
  "rgba(121, 236, 228, 0.5)",
  "rgba(233, 130, 114, 0.5)",
  "rgba(223, 230, 182, 0.5)",
  "rgba(198, 231, 115, 0.5)",
  "rgba(186, 152, 255, 0.5)",
  "rgba(250, 131, 195, 0.5)",
  "rgba(0, 194, 122, 0.5)",
  "rgba(67, 172, 239, 0.5)",
  "rgba(214, 129, 239, 0.5)",
  "rgba(216, 188, 110, 0.5)",
];
exports.bubblePointBootstrap5Colors = [
  "rgba(253, 126, 20, 0.5)",
  "rgba(102, 16, 242, 0.5)",
...
var funnelPointRender = function (args) {
  ...
  if (selectedTheme && selectedTheme.indexOf("fabric") > -1) {
    ...
    selectedTheme === "fluent2-highcontrast" ||
    selectedTheme === "fluent2-dark"
  ) {
...
var pointRenderEvent = function (args) {
  ...
  if (selectedTheme && selectedTheme.indexOf("fabric") > -1) {
    ...
    args.fill =
      exports.pointBootstrap5DarkColors[
        args.point.index % exports.pointBootstrap5DarkColors.length
      ];
  } else if (selectedTheme === "bootstrap5") {
    args.fill =
      exports.pointBootstrap5Colors[
        args.point.index % exports.pointBootstrap5Colors.length
      ];
  } else if (selectedTheme === "bootstrap") {
    args.fill =
      exports.pointBootstrapColors[
        args.point.index % exports.pointBootstrapColors.length
      ];
  } else if (selectedTheme === "bootstrap4") {
    args.fill =
      exports.pointBootstrapColors[
...
var bubblePointRender = function (args) {
  ...
  if (selectedTheme === "material-dark") {
    ...
    args.border.color =
      exports.pointBootstrap5DarkColors[args.point.index % 10];
  } else if (selectedTheme === "bootstrap5") {
    ...
    args.border.color =
      exports.pointFluent2HighContrastColors[args.point.index % 10];
...
var roundedPointRender = function (args) {
  ...
  if (selectedTheme && selectedTheme.indexOf("fabric-dark") > -1) {
    if (args.series.yName == "Rate") args.fill = "f9fafb";
  } else if (selectedTheme && selectedTheme.indexOf("fabric") > -1) {
    if (args.series.yName == "Rate") args.fill = "grey";
  } else if (selectedTheme === "material-dark") {
    if (args.series.yName == "Rate") args.fill = "f9fafb";
  } else if (selectedTheme === "material") {
    if (args.series.yName == "Rate") args.fill = "grey";
